...
const fetchSalesByMonth = async () => {
    ...
    const dataUNIT = {
        labels: topSellingProductsUnits.map(product => product.productName),
        datasets: [
            {
                label: 'Units Sold',
                data: topSellingProductsUnits.map(product => product.quantitySold),
                backgroundColor: [
                    'rgba(255, 99, 132, 0.6)',
                    'rgba(54, 162, 235, 0.6)',
                    'rgba(255, 206, 86, 0.6)',
...
<div className="chart-container">
        ...
        <div className="chart-container-pie">
            ...
            <Pie data={dataUNIT} options={optionsUNIT} />
        </div>
